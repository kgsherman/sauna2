...
var App = (function (_React$Component) {
	...
	function App() {
		...
		this.receiveUser = function (err, res) {
			if (err) {
				_this.setState({
					user: {
						loading: false,
		...
		this.authenticated = function () {
			return _react2['default'].createElement(
				'section',
				{ id: 'app' },
				_react2['default'].createElement(_header2['default'], _this.state.user),
		...
		this.notAuthenticated = function () {
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					'span',
					null,
					'Log in securely through Steam to get started'
				),
				_react2['default'].createElement(
					'a',
					{ href: '/auth/steam/' },
		...
		_superagent2['default'].get('/user', this.receiveUser);
	}
...
},{"./friends":3,"./header":4,"react":162,"superagent":163}],2:[function(require,module,exports){
'use strict';
...
var _libSteamuser = require('../lib/steamuser');

var _libSteamuser2 = _interopRequireDefault(_libSteamuser);
...
var Friend = (function (_React$Component) {
	...
	function Friend(props) {
		...
		_get(Object.getPrototypeOf(Friend.prototype), 'constructor', this).call(this, props);
		this.user = new _libSteamuser2['default'](this.props);
	}
	...
	_createClass(Friend, [{
		...
		value: function render() {
			return _react2['default'].createElement(
				'div',
				{ className: 'user-component ' + this.user.status },
				_react2['default'].createElement(
					'div',
					{ className: 'user-component-avatar' },
					_react2['default'].createElement('img', { src: this.user.data.avatar })
				),
				_react2['default'].createElement(
					'div',
					{ className: 'user-component-info' },
					_react2['default'].createElement(
						'div',
						{ className: 'user-component-info-name' },
						this.user.data.personaname
					),
					_react2['default'].createElement(
						'div',
						{ className: 'user-component-info-status' },
						this.user.data.englishStatus
					)
				)
			);
		}
...
},{"../lib/steamuser":6,"react":162}],3:[function(require,module,exports){
'use strict';
...
var FriendList = (function (_React$Component) {
	...
	function FriendList(props) {
		...
		this.receiveFriends = function (err, res) {
			if (err) {
				console.log(err);
				return;
			}
		...
		_superagent2['default'].get('/friends', this.receiveFriends);
	}
		...
		value: function render() {
			return _react2['default'].createElement(
				...
				this.state.friends.map(function (friend) {
					return _react2['default'].createElement(_friend2['default'], friend);
				})
			);
		}
	}]);
...
},{"../lib/steamuser":6,"./friend":2,"react":162,"superagent":163}],4:[function(require,module,exports){
'use strict';
...
var Header = (function (_React$Component) {
	...
	function Header(props) {
		...
		if (props.user) this.user = new _libSteamuser2['default'](props.user);
	}
	...
	_createClass(Header, [{
		...
		value: function render() {
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					'div',
					{ id: 'header-user', className: this.user.status },
					_react2['default'].createElement(
						'div',
						{ id: 'user-header-user-avatar' },
						_react2['default'].createElement('img', { src: this.user.data.avatar })
					),
					_react2['default'].createElement(
						'div',
				...
				_react2['default'].createElement(
					'div',
					{ id: 'header-login' },
					_react2['default'].createElement('img', { src: '/assets/steamlogo.png' })
				)
			);
		}
	}]);
...
},{"../lib/steamuser":6,"react":162}],5:[function(require,module,exports){
'use strict';
...
},{"./components/app":1,"react":162}],6:[function(require,module,exports){
'use strict';
...
var SteamUser = (function () {
	_createClass(SteamUser, null, [{
		key: 'statusMap',
		value: {
			'0': {
				label: 'Offline',
